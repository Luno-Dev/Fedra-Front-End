                        ...
                        <Col>
                            <CardGroup className="justify-content-center aling-items-center m-3">
                                <Card className="m-2 text-center aboutUS--Card">
                                    <Card.Body>
                                        <Card.Title className="text-cyan">Asamblea</Card.Title>
                                        <hr />
                                        <Card.Text>
                                ...
                                <Card className="m-2 text-center aboutUS--Card">
                                    <Card.Body>
                                        <Card.Title className="text-cyan">Comisión Directiva</Card.Title>
                                        <hr />
                                        <Card.Text>
                                ...
                                <Card className="m-2 text-center aboutUS--Card">
                                    <Card.Body>
                                        <Card.Title className="text-cyan">Mesa Chica</Card.Title>
                                        <hr />
                                        <Card.Text>
                                            Ejecuta las políticas de la Comisión Directiva y está integrada por tres directivos.
                                        </Card.Text>
                                    </Card.Body>
                                </Card>
                            </CardGroup>
